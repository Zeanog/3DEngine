...
class FunctionHandler : public IFunctorImpl_Compare<FunctionHandler<TFunctorOwner, _TFunctionPointer>, typename TFunctorOwner::TReturn, typename TFunctorOwner::TParamList> {
	INHERITED_CLASS_TYPEDEFS( FunctionHandler, TEMPLATE_3(IFunctorImpl_Compare, TEMPLATE_2(FunctionHandler, TFunctorOwner, _TFunctionPointer), typename TFunctorOwner::TReturn, typename TFunctorOwner::TParamList) )
